...
export default function Home() {
  return <main>
    <ScrollProgress />
    <header className="site-header page-width"><Logo /><nav aria-label="Primary navigation"><a href="#how">How it works</a><a href="#uses">Use cases</a><a href="#faq">FAQ</a><Link href="/dashboard">Dashboard</Link><Link href="/create" className="nav-cta">Create a benefit <ArrowRight size={16} /></Link></nav></header>
    <section className="hero page-width">
      <Reveal className="hero-copy"><p className="kicker">Benefits for the stocks already in your wallet</p><h1>Ownership,<br />made useful.</h1><p className="hero-lede">Create a private page that opens only for wallets holding enough eligible tokenized stock. The stock stays in the owner’s wallet.</p><div className="hero-actions"><Link href="/create" className="primary-button">Create a benefit <ArrowRight size={18} /></Link><Link href="/benefit/base-builder-session" className="text-link">Try the ready demo</Link></div><p className="hero-trust"><ShieldCheck size={16} /> Free on Base Sepolia. No purchase, deposit or API key needed.</p></Reveal>
      <OwnershipProof />
    </section>
    ...
    <section className="closing page-width"><p>Prove ownership. Keep custody. Unlock utility.</p><Link href="/create" className="primary-button inverted">Create your benefit <ArrowRight size={18} /></Link></section>
